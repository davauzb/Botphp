...
ob_start();
define('API_KEY','6676664084:AAHSZAcZ6i_Mal7bjs-Us8TKxvxKskPkBJg');
...
$db = mysqli_connect("localhost","67a6012a2c30b_auk","Davron3006","67a6012a2c30b_auk");
if($db){
echo "Ulandi</br>";
}else{
echo "error";
...
[['url'=>"https://t.me/$auksionkanal",'text'=>"👀 Auksionni kuzatish"]],
]
]);
...
[['url'=>"https://t.me/AnonymCoin",'text'=>"👨‍💻Texnik Yordam"]],
[['url'=>"https://t.me/$admin",'text'=>"👨‍💻Administrator"]],
[['url'=>"https://t.me/$tolovkanal",'text'=>"💳 To'lovlar"],['url'=>"https://t.me/$guruh",'text'=>"💬 Chat"]],
[['url'=>"https://t.me/$auksionkanal",'text'=>"🎩 Auksion Kanal"]],
...
[['url'=>"https://t.me/$guruh",'text'=>"💬 Rasmiy guruhimiz"]],
]
]);
...
if(!file_exists("sozlamalar/kanal/aukch.txt")){
    file_put_contents("sozlamalar/kanal/aukch.txt","");
}
if(!file_exists("sozlamalar/kanal/tulovch.txt")){
    file_put_contents("sozlamalar/kanal/tulovch.txt","");
}
if(!file_exists("sozlamalar/kanal/gr.txt")){
    file_put_contents("sozlamalar/kanal/gr.txt","");
}
if(!file_exists("sozlamalar/kanal/aukid.txt")){
    file_put_contents("sozlamalar/kanal/aukid.txt","-1002152142480");
}
if(!file_exists("sozlamalar/kanal/tulovid.txt")){
    file_put_contents("sozlamalar/kanal/tulovid.txt","-1002152142480");
}
if(!file_exists("sozlamalar/kanal/grid.txt")){
    file_put_contents("sozlamalar/kanal/grid.txt","-1002152142480");
}
if(!file_exists("sozlamalar/kanal/wait.txt")){
    file_put_contents("sozlamalar/kanal/wait.txt","");
}




$auksionkanal = file_get_contents("sozlamalar/kanal/aukch.txt");
$tolovkanal = file_get_contents("sozlamalar/kanal/tulovch.txt");
$guruh = file_get_contents("sozlamalar/kanal/gr.txt");
$auksionkanal_id = file_get_contents("sozlamalar/kanal/aukid.txt");
$tolovkanal_id = file_get_contents("sozlamalar/kanal/tulovid.txt");
$guruh_id = file_get_contents("sozlamalar/kanal/grid.txt");
...
"chat_id"=>"$auksionkanal_id",
"user_id"=>$uid,
])->result->status;
$kanal2= bot("getChatMember",[
"chat_id"=>"$tolovkanal_id",
"user_id"=>$uid,
])->result->status;
...
"inline_keyboard"=>[
[["text"=>"💳 To'lovlar","url"=>"https://t.me/$tolovkanal"],["text"=>"💬 Rasmiy guruh","url"=>"https://t.me/$guruh"]],
[["text"=>"🎩 Auksion Kanali","url"=>"https://t.me/$auksionkanal"]],
]
]),
]);
exit();
...
💬 Rasmiy guruh: <a href='https://t.me/$guruh'>AuksionChat</a>
💳 To'lovlar kanali: <a href='https://t.me/$tolovkanal'>AuksionPay</a>",$menu);
}else{
if(mb_stripos($ids,$uid)!==false){
auksion($cid,"👋 Assalomu alaykum, $name1
👨‍⚖️ Rasmiy Auksionga xush kelibsiz!
...
💬 Rasmiy guruh: <a href='https://$guruh'>AuksionChat</a>
💳 To'lovlar kanali: <a href='https://t.me/$tolovkanal'>AuksionPay</a>",$menu);
...
$panel = json_encode(['inline_keyboard'=>[
    ...
    [['callback_data'=>"chann",'text'=>"🎛️ Kanal Sozlamalari"]],
    [['callback_data'=>"exit",'text'=>"🚪Yopish"]],
]]);


$sozlamak = json_encode(['inline_keyboard'=>[
    [['callback_data'=>"holatt",'text'=>"#️⃣ Hozirgi Holat"]],
    [['callback_data'=>"u_auk",'text'=>"🔘 Auksion kanal user"],['callback_data'=>"id_auk",'text'=>"🔘 Auksion kanal ID"]],
    [['callback_data'=>"u_tulov",'text'=>"🔘 To‘lov kanal user"],['callback_data'=>"id_tulov",'text'=>"🔘 To‘lov kanal ID"]],
    [['callback_data'=>"u_guruh",'text'=>"🔘 Guruh user"],['callback_data'=>"id_gur",'text'=>"🔘 Guruh ID"]],
]]);
...
if($data=="chann"){
    bot('editMessageText',[
        ...
        "📢 Auksion kanali: @$auksionkanal\n".
        "💳 To‘lov kanali: @$tolovkanal\n".
        "👥 Guruh: @$guruh\n\n".
        "⚙️ O‘zgartirish uchun quyidagi tugmalardan foydalaning:",
        'parse_mode'=>"markdown",
        'reply_markup'=>$sozlamak
    ]);
}
if($data=="u_auk"){
    bot('sendMessage',[
        'chat_id'=>$cid,
        'text'=>"✏️ *Yangi Auksion kanali username (@username) kiriting:*",
        'parse_mode'=>"markdown",
        'reply_markup'=>json_encode(['force_reply'=>true])
    ]);
    file_put_contents("sozlamalar/kanal/wait.txt", "aukch");
}

if($data=="id_auk"){
    bot('sendMessage',[
        'chat_id'=>$cid,
        'text'=>"✏️ *Yangi Auksion kanali ID (raqam) kiriting:*",
        'parse_mode'=>"markdown",
        'reply_markup'=>json_encode(['force_reply'=>true])
    ]);
    file_put_contents("sozlamalar/kanal/wait.txt", "aukid");
}

if($data=="u_tulov"){
    bot('sendMessage',[
        'chat_id'=>$cid,
        'text'=>"✏️ *Yangi To‘lov kanali username (@username) kiriting:*",
        'parse_mode'=>"markdown",
        'reply_markup'=>json_encode(['force_reply'=>true])
    ]);
    file_put_contents("sozlamalar/kanal/wait.txt", "tulovch");
}

if($data=="id_tulov"){
    bot('sendMessage',[
        'chat_id'=>$cid,
        'text'=>"✏️ *Yangi To‘lov kanali ID (raqam) kiriting:*",
        'parse_mode'=>"markdown",
        'reply_markup'=>json_encode(['force_reply'=>true])
    ]);
    file_put_contents("sozlamalar/kanal/wait.txt", "tulovid");
}

if($data=="u_guruh"){
    bot('sendMessage',[
        'chat_id'=>$cid,
        'text'=>"✏️ *Yangi Guruh username (@username) kiriting:*",
        'parse_mode'=>"markdown",
        'reply_markup'=>json_encode(['force_reply'=>true])
    ]);
    file_put_contents("sozlamalar/kanal/wait.txt", "gr");
}

if($data=="id_gur"){
    bot('sendMessage',[
        'chat_id'=>$cid,
        'text'=>"✏️ *Yangi Guruh ID (raqam) kiriting:*",
        'parse_mode'=>"markdown",
        'reply_markup'=>json_encode(['force_reply'=>true])
    ]);
    file_put_contents("sozlamalar/kanal/wait.txt", "grid");
}


$wait = file_get_contents("sozlamalar/kanal/wait.txt");

if($wait=="aukch"){
    file_put_contents("sozlamalar/kanal/aukch.txt", $text);
    bot('sendMessage', ['chat_id'=>$cid, 'text'=>"✅ Auksion kanali yangilandi: @$text"]);
    file_put_contents("sozlamalar/kanal/wait.txt", "");
}

if($wait=="aukid"){
    file_put_contents("sozlamalar/kanal/aukid.txt", $text);
    bot('sendMessage', ['chat_id'=>$cid, 'text'=>"✅ Auksion kanali ID yangilandi: $text"]);
    file_put_contents("sozlamalar/kanal/wait.txt", "");
}

if($wait=="tulovch"){
    file_put_contents("sozlamalar/kanal/tulovch.txt", $text);
    bot('sendMessage', ['chat_id'=>$cid, 'text'=>"✅ To‘lov kanali yangilandi: @$text"]);
    file_put_contents("sozlamalar/kanal/wait.txt", "");
}

if($wait=="tulovid"){
    file_put_contents("sozlamalar/kanal/tulovid.txt", $text);
    bot('sendMessage', ['chat_id'=>$cid, 'text'=>"✅ To‘lov kanali ID yangilandi: $text"]);
    file_put_contents("sozlamalar/kanal/wait.txt", "");
}

if($wait=="gr"){
    file_put_contents("sozlamalar/kanal/gr.txt", $text);
    bot('sendMessage', ['chat_id'=>$cid, 'text'=>"✅ Guruh yangilandi: @$text"]);
    file_put_contents("sozlamalar/kanal/wait.txt", "");
}

if($wait=="grid"){
    file_put_contents("sozlamalar/kanal/grid.txt", $text);
    bot('sendMessage', ['chat_id'=>$cid, 'text'=>"✅ Guruh ID yangilandi: $text"]);
    file_put_contents("sozlamalar/kanal/wait.txt", "");
}
